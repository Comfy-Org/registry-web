...
const PREHEAT_ENABLED =
  process.env.VERCEL_ENV === "production" || process.env.PREHEAT_ENABLED === "true";
...
export const getStaticProps: GetStaticProps<{
  ...
  // translations remain in English until stored upstream. Bots are routed
  // to /_bot/nodes/[nodeId] by middleware for the blocking variant that
  // guarantees translated meta tags in HTML.
