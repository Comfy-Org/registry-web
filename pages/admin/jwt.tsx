...
import { HiCheck, HiClock, HiClipboard, HiEye, HiEyeOff, HiHome, HiX } from "react-icons/hi";
...
function AdminJwtPage() {
  ...
  const [firebaseTokenExpiry, setFirebaseTokenExpiry] = useState<Date | null>(null);
  ...
  const getTokenStatus = () => {
    if (!token) {
      return {
        ...
        icon: HiClock,
        description: t("No admin JWT token found. Generate one to perform admin operations."),
      };
    }
    if (isValid) {
      return {
  ...
  return (
    <div>
      ...
      <div className="p-4 max-w-4xl mx-auto">
        <h1 className="text-2xl font-bold text-gray-200 mb-6">{t("Admin JWT Token Management")}</h1>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <h2 className="text-xl font-semibold mb-4">{t("Firebase ID Token")}</h2>
            <div className="space-y-4">
                ...
                <>
                  <div className="relative">
                    <div className="flex gap-2">
                      <div className="relative flex-1">
                        ...
                        <button
                          type="button"
                          onClick={() => setShowFirebaseToken(!showFirebaseToken)}
                          ...
                          title={showFirebaseToken ? t("Hide token") : t("Show token")}
                        >
                          {showFirebaseToken ? (
                  ...
                  {firebaseTokenExpiry && (
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="text-gray-700 dark:text-gray-300">{t("Expires at:")} </span>
          ...
          <Card>
            <h2 className="text-xl font-semibold mb-4">{t("Token Management")}</h2>
            <div className="space-y-4">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {t(
          ...
          <Card>
            ...
            <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <p>{t("• Only users with admin privileges can generate JWT tokens.")}</p>
              <p>
                {t("• If you encounter issues, try clearing your token and generating a new one.")}
              </p>
            </div>
          </Card>
        </div>
