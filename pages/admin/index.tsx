...
function AdminDashboard() {
  ...
  return (
    <div className="p-4">
      ...
      <h1 className="text-2xl font-bold text-gray-200 mb-6">{t("Admin Dashboard")}</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <span className="text-center">{t("Search Ranking Table")}</span>
        </Link>
        <Link
        ...
        >
          ...
          <span className="text-center">{t("Preempted Comfy Node Names Management")}</span>
        </Link>
        <Link
        ...
        >
          ...
          <span className="text-center">{t("Review Node Versions")}</span>
        </Link>
        <Link
        ...
        >
          ...
          <span className="text-center">{t("Manage Unclaimed Nodes")}</span>
        </Link>
        <Link
        ...
        >
          ...
          <span className="text-center">{t("Node Version Compatibility")}</span>
        </Link>
        <Link
        ...
        >
          ...
          <span className="text-center">{t("Manage ComfyNodes")}</span>
        </Link>
      </div>
    </div>
  );
