...
import { getListNodesForPublisherQueryKey, useListNodesForPublisherV2 } from "@/src/api/generated";
...
function ClaimNodesPage() {
  ...
  const { data, isError, isLoading } = useListNodesForPublisherV2(UNCLAIMED_ADMIN_PUBLISHER_ID, {
    page: currentPage,
    limit: pageSize,
  });
    ...
    <div className="p-4">
      <div className="mb-6">
        ...
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-bold text-gray-200">{t("Unclaimed Nodes")}</h1>
          <div>
            <Button
              color="blue"
              ...
              <UnclaimedNodeCard
                ...
                onSuccess={() => {
                  ...
                  queryClient.invalidateQueries({
                    queryKey: getListNodesForPublisherQueryKey(UNCLAIMED_ADMIN_PUBLISHER_ID).slice(
                      0,
                      1,
                    ),
                  });
