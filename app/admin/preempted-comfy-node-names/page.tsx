...
import { useRouterQuery } from 'src/hooks/useRouterQuery.app'
...
// const Wrapped = withAdmin(PreemptedComfyNodeNamesAdminPage)

export default PreemptedComfyNodeNamesAdminPage
