        ...
        <div className="flex mt-2">
          {downloads != null && downloads > 0 && (
            <div className="flex justify-center text-center align-center">
              <HiDownload className="w-4 h-4 text-gray-300" title={t("Downloads")} />
              <p className="ml-1 text-xs font-bold text-gray-300">{ShortNumber(downloads)}</p>
            </div>
          )}
          {github_stars != null && github_stars > 0 && (
            <div className="flex justify-center ml-2 text-center align-center">
              <HiStar className="w-4 h-4 text-yellow-400" title={t("GitHub Stars")} />
              <p className="ml-1 text-xs font-bold text-gray-300">{ShortNumber(github_stars)}</p>
            </div>
          )}
          {rating != null && rating > 0 && (
            <div className="flex justify-center ml-2 text-center align-center">
              ...
              <p className="ml-1 text-xs font-bold text-gray-300">{rating.toFixed(1)}</p>
            </div>
          )}
        </div>
      </div>
