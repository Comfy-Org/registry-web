                            ...
                            {nodeVersions?.map((nv) => (
                                ...
                                >
                                    <div className="sticky left-0 z-10 flex gap-1 whitespace-nowrap bg-gray-800 w-[8rem] justify-end flex-0 justify-between">
                                        ...
                                        {nv.version}
                                        <Link href={`/admin/nodeversions?nodeId=${nv.node_id}&version=${nv.version}`} target='_blank' className="button flex-0 hover:bg-gray-700 hover:text-white transition-colors">
