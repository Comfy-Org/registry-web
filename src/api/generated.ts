...
export const getAdminUpdateNodeMutationOptions = <
  TError = ErrorResponse | void | ErrorResponse | ErrorResponse | ErrorResponse,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetNodeByComfyNodeNameQueryKey(comfyNodeName)
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof searchCustomers>>> = ({
    signal,
  }) => searchCustomers(params, requestOptions, signal)
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getCustomerById>>> = ({
    signal,
  }) => getCustomerById(customerId, requestOptions, signal)
...
>(
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getCustomerBalanceById>>
  > = ({ signal }) => getCustomerBalanceById(customerId, requestOptions, signal)
...
export const getCustomerEventsById = (
  ...
  return customInstance<GetCustomerEventsById200>(
    { url: `/customers/${customerId}/events`, method: 'GET', params, signal },
    options,
  )
}
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getGitcommit>>, TError, TData>
    >
    request?: SecondParameter<typeof customInstance>
  },
) => {
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof listAllNodes>>, TError, TData>
    >
    request?: SecondParameter<typeof customInstance>
  },
) => {
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof installNode>>, TError, TData>
    >
    request?: SecondParameter<typeof customInstance>
  },
) => {
...
>(
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listNodeVersions>>
  > = ({ signal }) => listNodeVersions(nodeId, params, requestOptions, signal)
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getNodeVersion>>, TError, TData>
    >
    request?: SecondParameter<typeof customInstance>
  },
) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getNodeVersion>>> = ({
    signal,
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof listComfyNodes>>, TError, TData>
    >
    request?: SecondParameter<typeof customInstance>
  },
) => {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListComfyNodesQueryKey(nodeId, version, params)

  const queryFn: QueryFunction<Awaited<ReturnType<typeof listComfyNodes>>> = ({
    signal,
...
export const getCreateComfyNodesMutationOptions = <
  TError = void | ErrorResponse | ErrorResponse | ErrorResponse | ErrorResponse,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getComfyNode>>, TError, TData>
    >
    request?: SecondParameter<typeof customInstance>
  },
) => {
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getByteplusVideoGenerationQueryQueryKey(taskId)
...
export const ideogramV3Remix = (
  ...
  if (ideogramV3RemixRequest.character_reference_images_mask !== undefined) {
    ideogramV3RemixRequest.character_reference_images_mask.forEach((value) =>
      formData.append(`character_reference_images_mask`, value),
    )
  }
...
export const ideogramV3ReplaceBackground = (
  ...
  if (ideogramV3ReplaceBackgroundRequest.style_reference_images !== undefined) {
    ideogramV3ReplaceBackgroundRequest.style_reference_images.forEach((value) =>
      formData.append(`style_reference_images`, value),
    )
  }
...
>(
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof klingQueryResourcePackages>>
  > = ({ signal }) => klingQueryResourcePackages(params, requestOptions, signal)
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getKlingVirtualTryOnQueryTaskListQueryKey(params)
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getKlingVirtualTryOnQuerySingleTaskQueryKey(id)
...
export const klingVideoEffectsQueryTaskList = (
  ...
  return customInstance<KlingVideoEffectsResponse>(
    { url: `/proxy/kling/v1/videos/effects`, method: 'GET', params, signal },
    options,
  )
}
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getKlingVideoEffectsQueryTaskListQueryKey(params)
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getKlingVideoEffectsQuerySingleTaskQueryKey(id)
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getKlingImage2VideoQueryTaskListQueryKey(params)
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getKlingImage2VideoQuerySingleTaskQueryKey(id)
...
export const klingLipSyncQueryTaskList = (
  ...
  return customInstance<KlingLipSyncResponse>(
    { url: `/proxy/kling/v1/videos/lip-sync`, method: 'GET', params, signal },
    options,
  )
}
...
>(
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof klingLipSyncQueryTaskList>>
  > = ({ signal }) => klingLipSyncQueryTaskList(params, requestOptions, signal)
...
export const klingText2VideoQueryTaskList = (
  ...
  return customInstance<KlingText2VideoResponse>(
    { url: `/proxy/kling/v1/videos/text2video`, method: 'GET', params, signal },
    options,
  )
}
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getKlingText2VideoQueryTaskListQueryKey(params)
...
>(
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof klingText2VideoQuerySingleTask>>
  > = ({ signal }) => klingText2VideoQuerySingleTask(id, requestOptions, signal)
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getKlingVideoExtendQueryTaskListQueryKey(params)
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getKlingVideoExtendQuerySingleTaskQueryKey(id)
...
export const retrieveMinimaxFile = (
  ...
  return customInstance<MinimaxFileRetrieveResponse>(
    { url: `/proxy/minimax/files/retrieve`, method: 'POST', params, signal },
    options,
  )
}
...
>(
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getMinimaxVideoGeneration>>
  > = ({ signal }) => getMinimaxVideoGeneration(params, requestOptions, signal)
...
export const getOpenAIResponse = (
  ...
  return customInstance<OpenAIResponse>(
    { url: `/proxy/openai/v1/responses/${id}`, method: 'GET', params, signal },
    options,
  )
}
...
export const pikaGenerate22KeyframeGenerate22PikaframesPost = (
  ...
  const formData = new FormData()
  if (
    pikaBodyGenerate22KeyframeGenerate22PikaframesPost.duration !== undefined
  ) {
    formData.append(
      `duration`,
  ...
  if (
    pikaBodyGenerate22KeyframeGenerate22PikaframesPost.keyFrames !== undefined
  ) {
  ...
  if (
    pikaBodyGenerate22KeyframeGenerate22PikaframesPost.resolution !== undefined
  ) {
    formData.append(
      `resolution`,
...
> => {
  const mutationOptions =
    getPikaGenerate22KeyframeGenerate22PikaframesPostMutationOptions(options)
...
export const pikaGenerate22C2vGenerate22PikascenesPost = (
  ...
  if (
    pikaBodyGenerate22C2vGenerate22PikascenesPost.negativePrompt !== undefined
  ) {
    formData.append(
      `negativePrompt`,
...
> => {
  const mutationOptions =
    getPikaGeneratePikadditionsGeneratePikadditionsPostMutationOptions(options)
...
export const pikaGeneratePikaffectsGeneratePikaffectsPost = (
  ...
  if (
    pikaBodyGeneratePikaffectsGeneratePikaffectsPost.promptText !== undefined
  ) {
    formData.append(
      `promptText`,
...
export const pikaGeneratePikaswapsGeneratePikaswapsPost = (
  ...
  if (
    pikaBodyGeneratePikaswapsGeneratePikaswapsPost.modifyRegionRoi !== undefined
  ) {
    formData.append(
      `modifyRegionRoi`,
  ...
  if (
    pikaBodyGeneratePikaswapsGeneratePikaswapsPost.negativePrompt !== undefined
  ) {
    formData.append(
      `negativePrompt`,
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getPikaGetVideoVideosVideoIdGetQueryKey(videoId)
...
export const stabilityImageGenrationUpscaleConservative = (
  ...
  const formData = new FormData()
  if (
    stabilityImageGenrationUpscaleConservativeRequest.creativity !== undefined
  ) {
    formData.append(
      `creativity`,
...
export const stabilityImageGenrationUpscaleCreative = (
  ...
  if (
    stabilityImageGenrationUpscaleCreativeRequest.negative_prompt !== undefined
  ) {
    formData.append(
      `negative_prompt`,
  ...
  if (
    stabilityImageGenrationUpscaleCreativeRequest.output_format !== undefined
  ) {
    formData.append(
      `output_format`,
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof tripoGetTask>>, TError, TData>
    >
    request?: SecondParameter<typeof customInstance>
  },
) => {
...
>(options?: {
  query?: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof tripoGetBalance>>, TError, TData>
  >
  request?: SecondParameter<typeof customInstance>
}) => {
  const { query: queryOptions, request: requestOptions } = options ?? {}
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof tripoGetBalance>>> = ({
    signal,
  }) => tripoGetBalance(requestOptions, signal)
...
>(options?: {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof listPublishers>>> = ({
    signal,
  }) => listPublishers(requestOptions, signal)
...
export const listNodesForPublisher = (
  ...
  return customInstance<Node[]>(
    { url: `/publishers/${publisherId}/nodes`, method: 'GET', params, signal },
    options,
  )
}
...
>(
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getPermissionOnPublisherNodes>>
  > = ({ signal }) =>
    getPermissionOnPublisherNodes(publisherId, nodeId, requestOptions, signal)
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetPermissionOnPublisherQueryKey(publisherId)
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListPersonalAccessTokensQueryKey(publisherId)
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getReleaseNotes>>> = ({
    signal,
  }) => getReleaseNotes(params, requestOptions, signal)
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof securityScan>>, TError, TData>
    >
    request?: SecondParameter<typeof customInstance>
  },
) => {
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetWorkflowResultQueryKey(workflowResultId)
