...
export const LongDescription: Story = {
  args: {
    ...
    description: 'This node generates procedural textures for 3D models with multiple parameters including roughness, metallic, and normal maps. It supports PBR workflows and can be integrated with various rendering engines.',
    publisherId: 'pub-789',
    totalInstall: 1800,
    latestVersion: '1.5.3',
...
export const UnclaimedNode: Story = {
  args: {
    id: 'node-789',
    name: 'Unclaimed Node',
    description: 'This is an unclaimed node that can be claimed by a publisher',
