...
/**
 * A simplified version of the AuthUI component for Storybook
 * This avoids Firebase dependencies and router navigation
 */
const AuthUIStory: React.FC<AuthUIStoryProps> = ({
    isLoading = false,
    error,
    showLoginButton = true,
    onGoogleSignIn = () => console.log('Google sign in clicked'),
    onGithubSignIn = () => console.log('GitHub sign in clicked'),
}) => {
    return (
        <section>
            <div className="absolute top-8 right-8 z-10">
                {/* Language Switcher placeholder */}
                <select className="bg-gray-800 text-white border border-gray-700 rounded p-2">
            ...
            <div className="flex items-center justify-center max-w-screen-xl px-4 py-16 mx-auto lg:grid lg:grid-cols-12 lg:gap-20 h-[100vh]">
                <div className="w-full col-span-12 mx-auto shadow bg-white-900 sm:max-w-lg md:mt-0 xl:p-0">
                    <Card className="max-w-md p-2 bg-gray-800 border border-gray-700 md:p-8 rounded-2xl">
                        ...
                        {isLoading && (
                            <div className="mt-4 p-3 bg-blue-600 text-white rounded text-center">
                                Signing in...
                            </div>
                        )}
